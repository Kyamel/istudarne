...
import { authSessionResponseSchema, refreshRequestSchema } from "@shared/contracts";
...
export const refreshRoute = createRoute({
	...
	description:
		...
		"reuse of an old token revokes every session of the user.",
	request: {
		body: jsonBody(refreshRequestSchema),
	},
	responses: {
		200: jsonResponse(authSessionResponseSchema, "New token pair issued."),
