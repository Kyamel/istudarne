/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bac5ccf4fced942470ddf8887aa249b4)
// Runtime types generated with workerd@1.20260401.1 2026-06-16 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "StudyGroupChat";
	}
	interface Env {
		QUIZ_FILES: R2Bucket;
		AI_QUEUE: Queue;
		...
		EMAIL_FROM: "Istudarne <no-reply@istudarne.com>";
		ALLOWED_ORIGINS: "capacitor://localhost,http://localhost:5173,http://localhost:5174,http://localhost:5175";
		...
		STUDY_GROUP_CHAT: DurableObjectNamespace<import("./src/index").StudyGroupChat>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "ALLOWED_ORIGINS" | "DATABASE_DRIVER" | "OPENAI_MODEL" | "AUTH_BASE_URL" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY" | "OPENAI_API_KEY">> {}
}
